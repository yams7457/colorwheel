    ...
    gate_tab = nest_ {
        ...
        gate_page = nest_ {
            ...
            gaterange_1 = _grid.range {
                ...
                value = function() 
                    return { params:get('gate sequence start 1'), params:get('gate sequence end 1') } --assuming these params are 1-16
                    end,
            ...
            gaterange_2 = _grid.range {
                ...
                value = function() 
                    return { params:get('gate sequence start 2'), params:get('gate sequence end 2') } --assuming these params are 1-16
                    end,
            ...
            gaterange_3 = _grid.range {
                ...
                value = function() 
                    return { params:get('gate sequence start 3'), params:get('gate sequence end 3') } --assuming these params are 1-16
                    end,
            ...
            gaterange_4 = _grid.range {
                ...
                value = function() 
                    return { params:get('gate sequence start 4'), params:get('gate sequence end 4') } --assuming these params are 1-16
                    end,
    ...
    interval_tab_1 = nest_ {
        ...
        enabled = function(self)
            ...
            interval_loop_1 = _grid.range {
                ...
                value = function() 
                    return { params:get('interval sequence start 1'), params:get('interval sequence end 1') } --assuming these params are 1-16
                    end,
    ...
    interval_tab_2 = nest_ {
        ...
        enabled = function(self)
            ...
            interval_loop_2 = _grid.range {
                ...
                value = function() 
                    return { params:get('interval sequence start 2'), params:get('interval sequence end 2') } --assuming these params are 1-16
                    end,
    ...
    interval_tab_3 = nest_ {
        ...
        enabled = function(self)
            ...
            interval_loop_3 = _grid.range {
                ...
                value = function() 
                    return { params:get('interval sequence start 3'), params:get('interval sequence end 3') } --assuming these params are 1-16
                    end,
      ...
      interval_tab_4 = nest_ {
        ...
        enabled = function(self)
            ...
            interval_loop_4 = _grid.range {
                ...
                value = function() 
                    return { params:get('interval sequence start 4'), params:get('interval sequence end 4') } --assuming these params are 1-16
                    end,
    ...
    octave_tab_1 = nest_ {
        ...
        enabled = function(self)
            ...
            octave_loop_1 = _grid.range {
                ...
                value = function() 
                    return { params:get('octave sequence start 1'), params:get('octave sequence end 1') } --assuming these params are 1-16
                    end,

        ...
        gate_page = nest_ {
            ...
            metarange = _grid.range {
                ...
                action = function(s, v)
                  ...
                  if meta_start_1 ~= meta_start_2 then
                  params:set('gate sequence start 1', params:get('meta loop start'))
                  params:set('gate sequence start 2', params:get('meta loop start'))
                  params:set('gate sequence start 3', params:get('meta loop start'))
                  params:set('gate sequence start 4', params:get('meta loop start'))
                  params:set('interval sequence start 1', params:get('meta loop start'))
                  params:set('interval sequence start 2', params:get('meta loop start'))
                  params:set('interval sequence start 3', params:get('meta loop start'))
                  params:set('interval sequence start 4', params:get('meta loop start'))
                  params:set('octave sequence start 1', params:get('meta loop start'))
                  params:set('octave sequence start 2', params:get('meta loop start'))
                  params:set('octave sequence start 3', params:get('meta loop start'))
                  params:set('octave sequence start 4', params:get('meta loop start'))                  
                  end
                  if meta_end_1 ~= meta_end_2 then
                  params:set('gate sequence end 1', params:get('meta loop end'))
                  params:set('gate sequence end 2', params:get('meta loop end'))
                  params:set('gate sequence end 3', params:get('meta loop end'))
                  params:set('gate sequence end 4', params:get('meta loop end'))
                  params:set('interval sequence end 1', params:get('meta loop end'))
                  params:set('interval sequence end 2', params:get('meta loop end'))
                  params:set('interval sequence end 3', params:get('meta loop end'))
                  params:set('interval sequence end 4', params:get('meta loop end'))
                  params:set('octave sequence end 1', params:get('meta loop end'))
                  params:set('octave sequence end 2', params:get('meta loop end'))
                  params:set('octave sequence end 3', params:get('meta loop end'))
                  params:set('octave sequence end 4', params:get('meta loop end'))
            ...
            gatefield_5 = nest_(16):each(function(i,v)
                ...
                return _grid.toggle {
                  ...
                  level = function(self)
                        ...
                        elseif params:get('gate 1 ' ..i) == 1 then return 4
            ...
            gatefield_6 = nest_(16):each(function(i,v)
                ...
                return _grid.toggle {
                  ...
                  level = function(self)
                        ...
                        elseif params:get('gate 2 ' ..i) == 1 then return 4
            ...
            gatefield_7 = nest_(16):each(function(i,v)
                ...
                return _grid.toggle {
                  ...
                  level = function(self)
                        ...
                        elseif params:get('gate 3 ' ..i) == 1 then return 4
            ...
            gatefield_8 = nest_(16):each(function(i,v)
                ...
                return _grid.toggle {
                  ...
                  level = function(self)
                        ...
                        elseif params:get('gate 4 ' ..i) == 1 then return 4
...
function init()
  ...
  gate_transport_2 = my_lattice:new_pattern{
      action = function(t) tick(2) 
        gate_transport_2.division = params:get('gate div 1') / 32
        end,
    ...
    gate_transport_3 = my_lattice:new_pattern{
      action = function(t) tick(3) 
        gate_transport_3.division = params:get('gate div 1') / 32
        end,
    ...
    gate_transport_4 = my_lattice:new_pattern{
      action = function(t) tick (4) 
        gate_transport_4.division = params:get('gate div 1') / 32
        end,
...
interval_transport_1 = my_lattice:new_pattern{
    ...
    division = params:get('interval div 1')
}
...
interval_transport_2 = my_lattice:new_pattern{
    ...
    division = params:get('interval div 2')
}
  ...
  interval_transport_3 = my_lattice:new_pattern{
    ...
    division = params:get('interval div 3')
}
  ...
  interval_transport_4 = my_lattice:new_pattern{
    ...
    division = params:get('interval div 4')
}
...
octave_transport_1 = my_lattice:new_pattern{
    ...
    division = params:get('octave div 1')
}
...
octave_transport_2 = my_lattice:new_pattern{
    ...
    division = params:get('octave div 2')
}
  ...
  octave_transport_3 = my_lattice:new_pattern{
    ...
    division = params:get('octave div 3')
}
  ...
  octave_transport_4 = my_lattice:new_pattern{
    ...
    division = params:get('octave div 4')
}
